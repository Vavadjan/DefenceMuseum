...
;// CONCATENATED MODULE: ./src/js/pages/gallery/sliders.js
...
;// CONCATENATED MODULE: ./src/js/pages/gallery/index.js
...
(function (proto) {
  proto.render = function (data) {
    this.data = data;
    this.$wrapper.html(Mustache.render(this.template, {
      folders: data
    }));
  };
  ...
  proto.init = function (data) {
    ...
    this.$wrapper.on("click", function (event) {
      var selectRootElem = event.target.closest(".gallery-folder-select");
      if (!selectRootElem) return;
      _this.setActiveFolderByIdx(selectRootElem.getAttribute("data-idx"));
    });
  };
...
function _onLoaded() {
  _onLoaded = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var mainGallery, mainGalleryThumbs, navGallery, response, _catalogue;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          mainGalleryThumbs = new MainGalleryThumbs();
          navGallery = new NavGallery(mainGallery, mainGalleryThumbs);
          _context.prev = 5;
          _context.next = 8;
          return fetch("https://museumdefence.ru/media/catalogue.json");
        case 8:
          response = _context.sent;
          _context.next = 11;
          return response.json();
        case 11:
          _catalogue = _context.sent;
          _catalogue.forEach(function (folderData, idx) {
            return folderData.idx = idx;
          });
          navGallery.init(_catalogue);
          _context.next = 19;
          break;
        case 16:
          _context.prev = 16;
          _context.t0 = _context["catch"](5);
          console.log("Catalogue index cannot be loaded", _context.t0);
        case 19:
        case "end":
